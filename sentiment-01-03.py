...
turkce = TextBlob("Yemek muhteşem lezzetliydi.")#"Google berbat bir arama motorudur.")
#print(type(turkce))
...
sentiment_dict = sid_obj.polarity_scores(english)
print(sentiment_dict)
"""
#sentiment nesnesi ile cümlenin porality ve subjectivty analizi yapılıp değerleri alınıyor.
